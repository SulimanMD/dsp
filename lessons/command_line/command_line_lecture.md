...
> Question: How could we make sure that we moved? by typing pwd 
...
would we do that? Answer: curl https://archive.ics.uci.edu/ml/machine-learning-databases/auto-mpg/auto-mpg.data -o data.txt
